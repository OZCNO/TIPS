  ...
  <div id="app">
    <!-- <el-col :span="18" :offset="3"> -->
      <el-card class="box-card">
        ...
        <!-- <el-form ref="resultForm" :inline="true" size="medium" :model="resultForm" label-width="96px">
        ...
        <el-table :data="list" :highlight-current-row="true" v-loading="listLoading" style="width: 100%" class="tableClass" size="medium" show-summary>
          <el-table-column type="index" width="80px" label="项目序号">
